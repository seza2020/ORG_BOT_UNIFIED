...
# Warmup alpha env injection (paper warmup only / safe if missing)
$warmupAlphaEnv = "C:\alpaca-bot\ORG_BOT_UNIFIED\ops\validation\warmup_alpha_env_v1.ps1"
if (Test-Path $warmupAlphaEnv) {
  . $warmupAlphaEnv
}
