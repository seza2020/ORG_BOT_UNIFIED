...
$latest = Get-ChildItem -LiteralPath $EVID -Directory -Filter "PYTHON_RUNTIME_REENTRY_FORENSIC_V1_*" |
...
if (!(Test-Path -LiteralPath $bak)) { throw "MAIN_BACKUP_NOT_FOUND=$bak" }
