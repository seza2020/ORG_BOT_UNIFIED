...
$OUT  = Join-Path $EVID ("CANONICAL_SINGLE_INSTANCE_GUARD_V1_CERTIFY_" + $TS)
...
@(
  "CANONICAL_SINGLE_INSTANCE_GUARD_V1_CERTIFY_DONE"
  ("OUT=" + $OUT)
