...
$GUARD   = Join-Path $WRAPDIR "CANONICAL_SINGLE_INSTANCE_GUARD_V1.ps1"

$latest = Get-ChildItem -LiteralPath $EVID -Directory -Filter "CANONICAL_SINGLE_INSTANCE_GUARD_V1_*" |
  Sort-Object LastWriteTime -Descending |
  Select-Object -First 1

if (-not $latest) { throw "NO_GUARD_BUNDLE_FOUND" }

$bak = Join-Path $latest.FullName "source_backup\CANONICAL_SINGLE_INSTANCE_GUARD_V1.ps1.bak"
