...
$OUT  = Join-Path $EVID ("DISABLE_FREEZE_SUPPORT_FIX_V1_CERTIFY_" + $TS)
...
foreach ($f in @($metaEvents,$metaEngine,$managerLog,$launcherLog)) {
...
@(
  "DISABLE_FREEZE_SUPPORT_FIX_V1_CERTIFY_DONE"
  ("OUT=" + $OUT)
  ("COUNT_AFTER_12S=" + $c12)
  ("COUNT_AFTER_20S=" + $c20)
