...
class SimpleMetaStrategyEngine:
    ...
    def __init__(
        self,
        *,
        min_state_confidence: float = 0.35,
    ...
    def from_env(cls) -> "SimpleMetaStrategyEngine":
        min_state_confidence = float(os.getenv("TBOT_META_MIN_STATE_CONF", "0.35") or "0.35")
        ...
        try:
            ...
            if conf < self.min_state_confidence:
                return MetaStrategyDecision(
                    ...
                    active_family="NONE",
                    size_mode="OFF",
                    extra={"min_state_confidence": self.min_state_confidence},
                )
